...
public class data_barang extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Ubah Data Barang");
                    ...
                    .addGroup(ubahBarangLayout.createSequentialGroup()
                        ...
                        .addGroup(ubahBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(ubahBarangLayout.createSequentialGroup()
                                ...
                                .addGap(46, 46, 46)
                                .addGroup(ubahBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtNamaBarangUbah, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtKodeBarangUbah)
                                    .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(txtJumlahUbah, javax.swing.GroupLayout.Alignment.LEADING)))
                            .addGroup(ubahBarangLayout.createSequentialGroup()
        ...
        ubahBarangLayout.setVerticalGroup(
            ...
            .addGroup(ubahBarangLayout.createSequentialGroup()
                ...
                .addGroup(ubahBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtKodeBarangUbah, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel11))
                .addGap(16, 16, 16)
                .addGroup(ubahBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtNamaBarangUbah, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12))
                .addGap(16, 16, 16)
                .addGroup(ubahBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                    .addComponent(txtJumlahUbah, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(16, 16, 16)
                .addGroup(ubahBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtJumlahBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        String sqlPencarian = "select * from tb_barang where kode_barang like '%" + txtCari.getText() + "%' or "
        + "nama_Barang like '%" + txtCari.getText() + "%' or "
        + "jumlah like '%" + txtCari.getText() + "%' or "
    ...
    private void btnSimpanUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanUbahActionPerformed
        String sql = "update tb_Barang set tanggal=?,kode_Barang=?,nama_Barang=?,jumlah=?,keterangan=? where kode_Barang='" + txtKodeBarangUbah.getText() + "'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        ...
        try {
            ...
            stat.setString(4, txtJumlahUbah.getText());
            stat.setString(5, txtKeteranganUbah.getText());
            stat.executeUpdate();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (row >= 0) {
            String id = tabelBarang.getValueAt(row, 2).toString();
